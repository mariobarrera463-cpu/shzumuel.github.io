      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gaming-text-muted max-w-sm mb-6">
            ...
            <div className="flex gap-4">
              <button className="p-2 bg-gaming-dark border border-gaming-border rounded-lg text-gaming-text-muted hover:text-gaming-text-primary hover:border-white transition-all">
                <Github size={20} />
              </button>
              <button className="p-2 bg-gaming-dark border border-gaming-border rounded-lg text-gaming-text-muted hover:text-gaming-blue hover:border-gaming-blue transition-all">
                <Twitter size={20} />
              </button>
              <button className="p-2 bg-gaming-dark border border-gaming-border rounded-lg text-gaming-text-muted hover:text-gaming-purple hover:border-gaming-purple transition-all">
          ...
          <div>
            <h4 className="text-gaming-text-primary font-bold uppercase tracking-widest text-sm mb-6">Explore</h4>
            <ul className="space-y-4 text-gaming-text-muted text-sm font-medium">
          ...
          <div>
            <h4 className="text-gaming-text-primary font-bold uppercase tracking-widest text-sm mb-6">Support</h4>
            <ul className="space-y-4 text-gaming-text-muted text-sm font-medium">
        ...
        <div className="mt-12 pt-8 border-t border-gaming-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gaming-text-muted/70 text-xs">
            © 2024 JewsGames Unblocked. All rights reserved.
          </p>
          <div className="flex gap-6">
            <span className="text-gaming-text-muted/70 text-[10px] font-mono tracking-widest uppercase">System Status: <span className="text-gaming-neon">Online</span></span>
            <span className="text-gaming-text-muted/70 text-[10px] font-mono tracking-widest uppercase">Region: <span className="text-gaming-blue">US-East</span></span>
          </div>
        </div>
      </div>
    </footer>
